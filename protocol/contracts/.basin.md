...
.basin is the primary BASIN Protocol contract. As a ERC-721 (6551 enabled) contract deployed on Polygon (MATIC), every .basin name is unique, has its own token ID, and it's own 0x account.&#x20;
